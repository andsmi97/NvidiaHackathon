...
const SearchPage: FC<IPersonPageProps> = () => {
  ...
  const project = {
    ...
    "projectImage": "https://images.unsplash.com/photo-1541969613518-f2097c466da8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1868&q=80",
    "persons": [
      {
        "personId": 1,
        "personName": "Piper Dingledine",
  ...
  return (<>
    ...
    <Container>
      ...
      <Grid container spacing={2} justify="center">
        {teamMates.map((teamMate: any) => (
          <Grid key={teamMate.personId} item spacing={2} sm={3} xs={12}>
            <PersonCard {...teamMate} />
          </Grid>
        ))}
      </Grid>
